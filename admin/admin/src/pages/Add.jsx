...
const Add = ({ token }) => {
  ...
  const onSubmitHandler=async(e)=>{
    ...
    try {
      ...
      const response = await axios.post('https://forever-nine-xi.vercel.app/api/product/add',formData,{headers:{token}})
    // console.log(token)
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          <p className='mb-2'>Product categroy</p>
        ...
        <div>
          <p className='mb-2'>Product SubCategroy</p>
      ...
      <button type="submit" className='w-28 py-3 mt-4 bg-black text-white border rounded-xl'>ADD</button>
